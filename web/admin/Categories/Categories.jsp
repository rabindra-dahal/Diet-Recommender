        ...
        <div class="banner">
            <div class="dietexpert-dot">
                ...
                <div class="layoutscontainer">
                    ...
                    <form action="./csave.jsp" autocomplete="off" name="additionalData" method="post">

                       <!-- <input type="hidden" name="u_id" value=""/>-->
                        <table id="mytable" name="mytable" style="margin:auto;">
                            <div class="container">
                                
                                <tr><th> <label style="color:white;margin-right: 20px;"><b>Category Name</b></label></th>
                                    <td><input type="text" id="c_name" placeholder="Enter Category Name" required="" name="c_name"></td></tr>
