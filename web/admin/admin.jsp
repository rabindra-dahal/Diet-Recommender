        ...
        <div class="banner">
            <div class="dietexpert-dot">
                ...
                <div class="layoutscontainer">
                    ...
                    <form action="./admincheck.jsp"  name="additionalData" method="post">

                       <!-- <input type="hidden" name="u_id" value=""/>-->
                        <table id="mytable" name="mytable" style="margin:auto;">
                            <div class="container">
                                <tr><th> <label style="color:white;margin-right: 20px;"><b>Usename</b></label></th>
                                    <td><input type="text"  id="username" placeholder="Enter Username" name="username" required></td></tr>

                                <tr><th> <label style="color:white;margin-right: 20px;"><b>Password</b></label></th>
                                    <td><input type="text" id="password" placeholder="Enter Password" required="" name="password"></td></tr>
